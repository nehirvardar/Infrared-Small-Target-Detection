...
# VERS1 CHANGE: Add Depthwise Seperable Convolution
...
# VERS2 CHANGE 1: Triple 3x3 convolution stem replacing the standard 7x7 convolution.
class TripleConvStem(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(TripleConvStem, self).__init__()
...
class DNANet_vers3(nn.Module):
    def __init__(self, num_classes, input_channels, block, num_blocks, nb_filter, deep_supervision=False):
        ...
        self.conv0_0 = TripleConvStem(input_channels, nb_filter[0])
